...
export default function MyVoters() {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            if (isMounted) fetchVoters(1, true);
        }, 400);
        return () => {
            isMounted = false;
            clearTimeout(timer);
        ...
        <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
                ...
                <View style={styles.detailsRow}>
                    ...
                    {/* Dynamic Gender Translation */}
                    <Text style={styles.detailText}>{item.gender === 'Male' ? t('male_label') : t('female_label')}</Text>
                    <Text style={styles.dot}> • </Text>
...
const styles = StyleSheet.create({
    ...
    searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', marginHorizontal: 20, marginTop: 15, paddingHorizontal: 15, borderRadius: 25, height: 45, elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
    input: { flex: 1, fontSize: 14, color: '#000' },

    listContent: { paddingBottom: 20, paddingHorizontal: 15, marginTop: 10 },
    card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 12, marginTop: 12, overflow: 'hidden', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2 },
